          ...
          >
            ...
            >
              ...
              <div className="text-center mb-8">
                <div className="w-16 h-16 bg-gradient-to-br from-primary to-primary-dark rounded-2xl flex items-center justify-center shadow-lg mx-auto mb-4">
                      ...
                      <div className="border-2 border-dashed border-slate-300 dark:border-slate-600 rounded-2xl p-6 text-center hover:border-primary-DEFAULT transition-colors duration-300 bg-slate-50/50 dark:bg-slate-700/30">
                        {userInput.videoSrc ? (
                          <div className="space-y-4">
                            ...
                            />
                            <p className="text-sm text-secondary font-medium">Video uploaded successfully!</p>
                          </div>
                        ) : (
                          <div className="space-y-4">
                            ...
                            <button
                              ...
                              className="bg-gradient-to-r from-primary to-primary-dark hover:from-primary-dark hover:to-primary-900 text-white px-6 py-3 rounded-xl font-medium transition-all duration-300 shadow-lg hover:shadow-xl"
                            >
                              Choose File
                            </button>
                          </div>
                ...
                >
                    ...
                    <div className="space-y-5">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 border border-slate-300 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-primary focus:border-transparent bg-white dark:bg-slate-700 text-slate-900 dark:text-white transition-all duration-200"
                          required
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          className="w-full px-4 py-3 border border-slate-300 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-primary focus:border-transparent bg-white dark:bg-slate-700 text-slate-900 dark:text-white transition-all duration-200 resize-none"
                          required
                        />
                      </div>
                    </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2 flex items-center gap-2">
                          <FaGoogleDrive className="text-primary" />
                          Google Drive URL
                        </label>
                        <input
                          type="url"
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 border border-slate-300 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-secondary focus:border-transparent bg-white dark:bg-slate-700 text-slate-900 dark:text-white transition-all duration-200"
                        />
